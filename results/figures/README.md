...
![Global GM CBF by group](gm_cbf_by_group_centered.png)
Mean global gray matter CBF compared between patients and controls.

## Left Superior Frontal Gyrus (LSFG)
![LSFG CBF by group](lsfg_cbf_by_group_centered.png)
...
![LMFG CBF by group](lmfg_cbf_by_group_centered.png)
...
![RMOG CBF by group](rmog_cbf_by_group_centered.png)
...
## Left Putamen (LPUT)
![LPUT CBF by group](lput_cbf_by_group_centered.png)
...
![Network analysis results](network_analysis_results.png)
...
![Network level summary](network_level_summary.png)
